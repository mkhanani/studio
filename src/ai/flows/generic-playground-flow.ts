...
const prompt = ai.definePrompt({
  ...
  If the tool name is 'Scribe', please provide a well-structured response using Markdown for formatting (e.g., headings, lists, bold text). Your response should be directly usable as a document.
  If the tool name is 'DataGrid', please provide the response as raw, valid CSV data and nothing else. Ensure the first row is the header.
